...
public static class BusinessObjectPartialClass
{
	public static void Generate(Table table, CsprojFile csprojFile)
	{
		...
		BusinessObjectConstructors.WriteConstructors(writer, ClassHelper.GetClassName(table), TableHelper.GetPrimaryKey(table).Name, baseClass: false);
	...
	public static void WriteNamespaceClassBegin(CodeWriter writer, Table table)
	{
