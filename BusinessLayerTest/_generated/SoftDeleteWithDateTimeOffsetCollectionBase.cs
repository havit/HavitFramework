...
namespace Havit.BusinessLayerTest
{
	...
	public partial class SoftDeleteWithDateTimeOffsetCollectionBase : BusinessObjectCollection<SoftDeleteWithDateTimeOffset, SoftDeleteWithDateTimeOffsetCollection>
	{
		#region Constructors
		/// <summary>
		/// Vytvoří novou instanci kolekce.
		/// </summary>
		public SoftDeleteWithDateTimeOffsetCollectionBase() : base()
		{
		}
		...
		/// </summary>
		public SoftDeleteWithDateTimeOffsetCollectionBase(IEnumerable<SoftDeleteWithDateTimeOffset> collection) : base(collection)
		{
		}
		#endregion
		...
		/// </summary>
		public override SoftDeleteWithDateTimeOffset Find(Predicate<SoftDeleteWithDateTimeOffset> match)
		{
			LoadAll();
		...
		/// </summary>
		public override SoftDeleteWithDateTimeOffsetCollection FindAll(Predicate<SoftDeleteWithDateTimeOffset> match)
		{
			LoadAll();
		...
		public override void Sort(Comparison<SoftDeleteWithDateTimeOffset> comparsion)
		{
			LoadAll();
		...
		public void LoadAll(DbTransaction transaction)
		{
			...
			Dictionary<int, SoftDeleteWithDateTimeOffset> ghosts = new Dictionary<int, SoftDeleteWithDateTimeOffset>();
			
			for (int i = 0; i < this.Count; i++)
			{
				SoftDeleteWithDateTimeOffset currentObject = this[i];
			...
			if (ghosts.Count > 0)
			{
				...
				queryParams.Conditions.Add(ReferenceCondition.CreateIn(SoftDeleteWithDateTimeOffset.Properties.ID, ghosts.Keys.ToArray()));
				...
				using (DbDataReader reader = DbConnector.Default.ExecuteReader(dbCommand))
				{
					while (reader.Read())
					{
						...
						SoftDeleteWithDateTimeOffset ghost = ghosts[id];
						if (!ghost.IsLoaded)
						{
