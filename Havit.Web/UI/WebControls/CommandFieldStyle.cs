...
{
	/// <summary>
	/// Zapouzd¯enÌ pro skinov·nÌ CommandFieldu, uloûiötÏ hodnot.
	/// </summary>
	public class CommandFieldStyle : IStateManager
	{
		...
		/// <summary>
		/// Text, na kter˝ se m· pt·t jscript:confirm() p¯ed smaz·nÌm z·znamu. Pokud je pr·zdn˝, na nic se nept·.
		/// </summary>
		[Category("Appearance")]
		[Localizable(true)]
		[DefaultValue("")]
		...
		/// <summary>
		/// Ud·lost, kter· se zavol· p¯i zmÏnÏ nÏkterÈ property.
		/// </summary>
		...
		/// <summary>
		/// Zajiöùuje spuötÏnÌ ud·losti <see cref="PropertyChanged"/>.
		/// </summary>
