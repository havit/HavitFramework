...
namespace Havit.Drawing
{
	...
	public static class BitmapExt
	{
		...
		/// </summary>
		/// <remarks>
		/// Tato varianta implementace obchází nemožnost zápisu do otevøeného obrázku jeho vykopírováním,
		/// uzavøením a uložením. Je proto o malinko pomalejší než vytvoøení cílového obrázku do vedlejšího souboru.
		/// </remarks>
		...
		/// </remarks>
		/// <param name="sourceFilename">zdrojový obrázek (název souboru vèetnì cesty)</param>
		/// <param name="destinationFilename">cílový obrázek (název souboru vèetnì cesty)</param>
		/// <param name="width">cílová šíøka</param>
		/// <param name="height">cílová výška</param>
		/// <param name="resizeMode"><see cref="ResizeMode"/> možnost urèující režim</param>
		/// <param name="quality">kvalita pøevodu a výsledného obrázku 0-100</param>
		/// <returns><see cref="Size"/> s rozmìry výsledného obrázku</returns>
