...
namespace Havit.Xml.Rss
{
	...
	public class RssItem
	{
		...
		/// Souèasná implementace umožòuje zadání pouze jedné kategorie.
		/// </summary>
		[XmlElement("category")]
		...
		/// </summary>
		/// <remarks>
		/// Nutno zachovat kvùli XmlSerializeru, který vyžaduje pøítomnost default constructoru.
		/// </remarks>
		public RssItem()
		{
		}
		...
		/// <summary>
		/// Vytvoøí RSS item s povinnými položkami
		/// </summary>
