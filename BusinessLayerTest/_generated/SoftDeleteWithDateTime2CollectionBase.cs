...
namespace Havit.BusinessLayerTest
{
	...
	public partial class SoftDeleteWithDateTime2CollectionBase : BusinessObjectCollection<SoftDeleteWithDateTime2, SoftDeleteWithDateTime2Collection>
	{
		#region Constructors
		/// <summary>
		/// Vytvoří novou instanci kolekce.
		/// </summary>
		public SoftDeleteWithDateTime2CollectionBase() : base()
		{
		}
		...
		/// </summary>
		public SoftDeleteWithDateTime2CollectionBase(IEnumerable<SoftDeleteWithDateTime2> collection) : base(collection)
		{
		}
		#endregion
		...
		/// </summary>
		public override SoftDeleteWithDateTime2 Find(Predicate<SoftDeleteWithDateTime2> match)
		{
			LoadAll();
		...
		/// </summary>
		public override SoftDeleteWithDateTime2Collection FindAll(Predicate<SoftDeleteWithDateTime2> match)
		{
			LoadAll();
		...
		public override void Sort(Comparison<SoftDeleteWithDateTime2> comparsion)
		{
			LoadAll();
		...
		public void LoadAll(DbTransaction transaction)
		{
			...
			Dictionary<int, SoftDeleteWithDateTime2> ghosts = new Dictionary<int, SoftDeleteWithDateTime2>();
			
			for (int i = 0; i < this.Count; i++)
			{
				SoftDeleteWithDateTime2 currentObject = this[i];
			...
			if (ghosts.Count > 0)
			{
				...
				queryParams.Conditions.Add(ReferenceCondition.CreateIn(SoftDeleteWithDateTime2.Properties.ID, ghosts.Keys.ToArray()));
				...
				using (DbDataReader reader = DbConnector.Default.ExecuteReader(dbCommand))
				{
					while (reader.Read())
					{
						...
						SoftDeleteWithDateTime2 ghost = ghosts[id];
						if (!ghost.IsLoaded)
						{
