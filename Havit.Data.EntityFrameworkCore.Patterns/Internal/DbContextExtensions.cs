...
internal static class DbContextExtensions
{
	...
	private static bool SupportsSqlServerOpenJson(this IDbContext dbContext)
	{
	...
	private static ParameterTranslationMode? GetParameterTranslationMode(this IDbContext dbContext)
	{
	...
	/// </summary>
	internal static bool ShouldUseChunkingForContainsCondition(this IDbContext dbContext, int valuesToLoadCount, out int chunkSize)
	{
		...
		bool supportSqlServerOpenJson = dbContext.SupportsSqlServerOpenJson();
		var parameterTranslationMode = dbContext.GetParameterTranslationMode();
