<%@ Page Language="C#" AutoEventWireup="false" Codebehind="NumericBoxTest.aspx.cs"
	Inherits="Havit.WebApplicationTest.HavitWebTests.NumericBoxTest" %>
...
<body>
	<form id="form1" runat="server">
		<div>			
			...
			<havit:FormViewExt ID="MyFormView" DefaultMode="Edit" ItemType="Havit.WebApplicationTest.HavitWebTests.NumericBoxTest.DataClass" runat="server">
				<EditItemTemplate>					
