...
/// <inheritdoc />
public class ReferencingNavigationsStorageBuilder : IReferencingNavigationsStorageBuilder
{
	...
	/// Konstruktor.
	/// </summary>
	public ReferencingNavigationsStorageBuilder(IDbContext dbContext)
	{
		_dbContext = dbContext;
	}

	/// <inheritdoc />
	public IReferencingNavigationsStorage Build()
	{
		return new ReferencingNavigationsStorage
		{
			Value = _dbContext.Model.GetEntityTypes() // získáme entity types				
