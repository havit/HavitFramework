...
namespace Havit.BusinessLayerTest.Resources
{
	...
	public abstract class ResourceItemBase : ActiveRecordBusinessObjectBase, ILocalizable
	{
		...
		/// <summary>
		/// Klíč položky v rámci ResourceClass [varchar(100), not-null]
		/// </summary>
		...
		/// <summary>
		/// Popis pro administraci. [nvarchar(200), nullable]
		/// </summary>
		...
		{
			string cacheKey = "Havit.BusinessLayerTest.Resources.ResourceItem.DataRecordsCache|ID=" + id.ToString();
		...
		{
			HttpRuntime.Cache.Remove("Havit.BusinessLayerTest.Resources.ResourceItem.GetAll");
		}
		#endregion
		...
		private static ResourceItemCollection GetList(DbCommand dbCommand, DataLoadPower dataLoadPower)
		{
			...
			using (DbDataReader reader = DbConnector.Default.ExecuteReader(dbCommand))
			{
				while (reader.Read())
				{
					...
					{
						AddDataRecordToCache(resourceItem.ID, dataRecord);
					}
