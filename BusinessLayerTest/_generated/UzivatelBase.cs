...
namespace Havit.BusinessLayerTest
{
	...
	public abstract class UzivatelBase : ActiveRecordBusinessObjectBase
	{
		...
		public string GetSaveCacheDependencyKey(bool ensureInCache = true)
		{
			...
			if (ensureInCache)
			{
				Havit.Business.BusinessLayerContexts.BusinessLayerCacheService.EnsureCacheDependencyKey(typeof(Uzivatel), key);
			}
		...
		protected void InvalidateSaveCacheDependencyKey()
		{
			if (Havit.Business.BusinessLayerContexts.BusinessLayerCacheService.SupportsCacheDependencies)
			{
				Havit.Business.BusinessLayerContexts.BusinessLayerCacheService.InvalidateCacheDependencies(typeof(Uzivatel), GetSaveCacheDependencyKey(false));
			}
		}
		...
		protected static void InvalidateAnySaveCacheDependencyKey()
		{
			if (Havit.Business.BusinessLayerContexts.BusinessLayerCacheService.SupportsCacheDependencies)
			{
				Havit.Business.BusinessLayerContexts.BusinessLayerCacheService.InvalidateCacheDependencies(typeof(Uzivatel), GetAnySaveCacheDependencyKey(false));
			}
		}
		#endregion
