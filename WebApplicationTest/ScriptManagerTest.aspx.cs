...
namespace WebApplicationTest
{
	public partial class ScriptManagerTest : System.Web.UI.Page
	{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			ScriptManager.ScriptResourceMapping.AddDefinition("test1", new ScriptResourceDefinition { Path = "~/a.js" });
			ScriptManager.ScriptResourceMapping.AddDefinition("test2", new ScriptResourceDefinition { Path = "~/b.js" });
