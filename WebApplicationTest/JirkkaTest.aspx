<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JirkkaTest.aspx.cs" Inherits="WebApplicationTest.JirkkaTest" %>
...
Integer urna. Nunc ac urna pulvinar purus blandit euismod. Donec in risus. Suspendisse scelerisque euismod nunc. Aenean elementum convallis ante. In rhoncus, diam ac mattis fermentum, urna sapien ornare quam, dignissim lacinia nisl libero et velit. Maecenas odio. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum nisi. Vivamus vestibulum eleifend tellus. 
	...
	<havit:AjaxModalDialog ID="MyAjaxModalDialog" runat="server" Width="200" Height="200">
		...
		<asp:Button runat="server" Text="Refresh" />
			<%= DateTime.Now %>
			<asp:Button runat="server" ID="EnlargeButton" /><br /><br />
			assssssss: 
				<div>
