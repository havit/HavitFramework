...
namespace Havit.BusinessLayerTest
{
	...
	public partial class RoleLocalization : RoleLocalizationBase
	{
		...
		protected RoleLocalization() : this(ConnectionMode.Connected)
		{
		}
		...
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		protected RoleLocalization(ConnectionMode connectionMode) : base(connectionMode)
		{
		}
		...
		/// <param name="connectionMode">Režim business objektu.</param>
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		protected RoleLocalization(int id, ConnectionMode connectionMode = ConnectionMode.Connected) : base(id, connectionMode)
		{
		}
		...
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		protected RoleLocalization(int id, DataRecord record) : base(id, record)
		{
		}
		#endregion
		...
		/// <param name="id">RoleLocalizationID (PK).</param>
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		public static RoleLocalization GetObject(int id)
		{
			RoleLocalization result;
			...
			if (currentIdentityMap.TryGet<RoleLocalization>(id, out result))
			{
				return result;
			}
			...
			result = (RoleLocalization)GetBusinessObjectFromCache(id);
			if (result == null)
			{
				lock (lockGetObjectCacheAccess)
				{
					...
					{
						fromCache = false;
						result = new RoleLocalization(id);
		...
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		internal static RoleLocalization GetObject(DataRecord dataRecord)
		{
			global::Havit.Diagnostics.Contracts.Contract.Requires(dataRecord != null);
			
			RoleLocalization result = null;
			...
			{
				result = RoleLocalization.GetObject(id);
			...
			{
				result = new RoleLocalization(id, dataRecord);
			}
		...
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		public static RoleLocalization GetObjectOrDefault(int? id, RoleLocalization defaultValue = null)
		{
		...
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		public static RoleLocalizationCollection GetObjects(params int[] ids)
		{
			global::Havit.Diagnostics.Contracts.Contract.Requires(ids != null, "ids != null");
			
			return new RoleLocalizationCollection(Array.ConvertAll<int, RoleLocalization>(ids, id => RoleLocalization.GetObject(id)));
		}
		...
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		public static RoleLocalization CreateDisconnectedObject()
		{
			return new RoleLocalization(ConnectionMode.Disconnected);
		}
		...
		/// </summary>
		[System.CodeDom.Compiler.GeneratedCode("Havit.BusinessLayerGenerator", "1.0")]
		public static RoleLocalization CreateDisconnectedObject(int id)
		{
			return new RoleLocalization(id, ConnectionMode.Disconnected);
		}
		#endregion
