...
namespace Havit.BusinessLayerTest
{
	...
	public partial class UzivatelCollectionBase : BusinessObjectCollection<Uzivatel, UzivatelCollection>
	{
		...
		public void LoadAll(DbTransaction transaction)
		{
			...
			Dictionary<int, Uzivatel> ghosts = new Dictionary<int, Uzivatel>();
			...
			if (ghosts.Count > 0)
			{
				...
				queryParams.Conditions.Add(ReferenceCondition.CreateIn(Uzivatel.Properties.ID, ghosts.Keys.ToArray()));
