...
namespace Havit.EFCoreTests.Entity.Migrations
{
    ...
    [Migration("20250416120309_Migration_ManyToMany")]
    partial class Migration_ManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Havit.EFCoreTests.Model.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("User_AdditionalRoles", b =>
                {
                    ...
                    b.ToTable("User_AdditionalRoles");
                });

            modelBuilder.Entity("User_PrimaryRoles", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("User_PrimaryRoles");
                });

            modelBuilder.Entity("User_SecondaryRoles", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("User_AdditionalRoles", b =>
                {
                    b.HasOne("Havit.EFCoreTests.Model.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Havit.EFCoreTests.Model.User", null)
                        .WithMany("AdditionalUserRoles")
            ...
            modelBuilder.Entity("Havit.EFCoreTests.Model.User", b =>
                {
                    b.Navigation("AdditionalUserRoles");
                });
