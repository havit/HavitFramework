...
namespace Havit.BusinessLayerTest
{
	...
	public partial class CenikItemCollectionBase : BusinessObjectCollection<CenikItem, CenikItemCollection>
	{
		#region Constructors
		/// <summary>
		/// Vytvoří novou instanci kolekce.
		/// </summary>
		public CenikItemCollectionBase() : base()
		{
		}
		...
		/// </summary>
		public CenikItemCollectionBase(IEnumerable<CenikItem> collection) : base(collection)
		{
		}
		#endregion
		...
		/// </summary>
		public override CenikItem Find(Predicate<CenikItem> match)
		{
			LoadAll();
		...
		/// </summary>
		public override CenikItemCollection FindAll(Predicate<CenikItem> match)
		{
			LoadAll();
		...
		public override void Sort(Comparison<CenikItem> comparsion)
		{
			LoadAll();
		...
		public void LoadAll(DbTransaction transaction)
		{
			...
			Dictionary<int, CenikItem> ghosts = new Dictionary<int, CenikItem>();
			
			for (int i = 0; i < this.Count; i++)
			{
				CenikItem currentObject = this[i];
			...
			if (ghosts.Count > 0)
			{
				...
				queryParams.Conditions.Add(ReferenceCondition.CreateIn(CenikItem.Properties.ID, ghosts.Keys.ToArray()));
