...
namespace Havit.BusinessLayerTest
{
	...
	public abstract class UzivatelBase : ActiveRecordBusinessObjectBase
	{
		...
		static UzivatelBase()
		{
			...
			objectInfo.Initialize("dbo", "Uzivatel", false, Uzivatel.CreateObject, Uzivatel.GetObject, Uzivatel.GetAll, properties.Deleted, properties.All);
		...
		/// <summary>
		/// Uživatelské jméno, kterým se uživatel přihlašuje. [varchar(50), not-null]
		/// </summary>
		...
		/// <summary>
		/// Heslo uživatele. [nvarchar(30), not-null]
		/// </summary>
		...
		/// <summary>
		/// Jméno uživatele, jak se má zobrazovat pro přihlášení. [nvarchar(50), not-null]
		/// </summary>
		...
		/// <summary>
		/// Email uživatele. [nvarchar(100), not-null]
		/// </summary>
