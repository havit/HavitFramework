...
// full day names
Calendar._DN = new Array("Neděľa", "Pondelok", "Utorok", "Streda", "Štvrtok", "Piatok", "Sobota", "Neděľa");
// short day names
Calendar._SDN = new Array("Ned", "Pon", "Uto", "Str", "Štv", "Pia", "Sob", "Ned");
// full month names
...
Calendar._TT["ABOUT"] =
    "DHTML Date/Time Selector\n" +
        ...
        "Distribuovano pod GNU LGPL.  Viz http://gnu.org/licenses/lgpl.html pre detaily." +
        "\n\n" +
        "Výber dátumu:\n" +
...
Calendar._TT["SUN_FIRST"] = "Zobraziť neděľu ako prvú";
...
// Jiri Kanda
Calendar._FD = 1;
Calendar._TT["DAY_FIRST"] = "Zobraziť %s ako prvú";
Calendar._TT["WEEKEND"] = "0,6";
Calendar._TT["TIME"] = "Čas:";
Calendar._TT["TOGGLE"] = "Zmeniť prvý deň v týdnu";
