...
namespace Havit.Web.UI.WebControls
{
	...
	public class DynarchCalendar : System.Web.UI.Control
	{
		...
		/// Default je ~/scripts/calendar_stripped.js
		/// </summary>
		...
		private static string mainScriptUrl = "~/scripts/calendar_stripped.js";

		/// <summary>
		/// Cesta k vybranému jazykovému skriptu calendar-{lang}.js
		/// Default je ~/scripts/calendar-cs-utf8.js
		/// nebo ~/scripts/calendar-cs-win.js, podle Response.ContentEncoding
		/// </summary>
		public static string LanguageScriptUrl
		{
			get
			{
				if (languageScriptUrl.Length == 0)
				{
					if (HttpContext.Current.Response.ContentEncoding == Encoding.UTF8)
					{
						return "~/scripts/calendar-cs-utf8.js";
					}
					else
					{
						return "~/scripts/calendar-cs-win.js";
					}
				}
				else
				{
		...
		private static string setupScriptUrl = "~/scripts/calendar-setup_stripped.js";
		#endregion
