...
namespace Havit.BusinessLayerTest
{
	...
	public partial class KomunikaceCollectionBase : BusinessObjectCollection<Komunikace, KomunikaceCollection>
	{
		...
		/// </summary>
		public KomunikaceCollectionBase() : base()
		{
		}
		...
		/// </summary>
		public KomunikaceCollectionBase(IEnumerable<Komunikace> collection) : base(collection)
		{
		}
		#endregion
		...
		/// </summary>
		public override Komunikace Find(Predicate<Komunikace> match)
		{
			LoadAll();
		...
		/// </summary>
		public override KomunikaceCollection FindAll(Predicate<Komunikace> match)
		{
			LoadAll();
		...
		public override void Sort(Comparison<Komunikace> comparsion)
		{
			LoadAll();
		...
		public void LoadAll(DbTransaction transaction)
		{
			...
			queryParams.Conditions.Add(ReferenceCondition.CreateIn(Komunikace.Properties.ID, ghosts.ToArray()));
			...
			using (DbDataReader reader = DbConnector.Default.ExecuteReader(dbCommand))
			{
				while (reader.Read())
				{
					...
					foreach (Komunikace ghost in this)
					{
