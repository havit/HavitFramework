...
namespace Havit.BusinessLayerTest
{
	...
	public partial class ObjednavkaSepsaniCollectionBase : BusinessObjectCollection<ObjednavkaSepsani, ObjednavkaSepsaniCollection>
	{
		//------------------------------------------------------------------------------
		// <auto-generated>
		//     This code was generated by a tool.
		...
		/// </summary>
		public ObjednavkaSepsaniCollectionBase() : base()
		{
		}
		...
		/// </summary>
		public ObjednavkaSepsaniCollectionBase(IEnumerable<ObjednavkaSepsani> collection) : base(collection)
		{
		}
		#endregion
		...
		/// </summary>
		public override ObjednavkaSepsani Find(Predicate<ObjednavkaSepsani> match)
		{
			LoadAll();
		...
		/// </summary>
		public override ObjednavkaSepsaniCollection FindAll(Predicate<ObjednavkaSepsani> match)
		{
			LoadAll();
		...
		public override void Sort(Comparison<ObjednavkaSepsani> comparsion)
		{
			LoadAll();
		...
		public void LoadAll(DbTransaction transaction)
		{
			...
			Dictionary<int, ObjednavkaSepsani> ghosts = new Dictionary<int, ObjednavkaSepsani>();
			
			for (int i = 0; i < this.Count; i++)
			{
				ObjednavkaSepsani currentObject = this[i];
			...
			if (ghosts.Count > 0)
			{
				...
				queryParams.Conditions.Add(ReferenceCondition.CreateIn(ObjednavkaSepsani.Properties.ID, ghosts.Keys.ToArray()));
				...
				using (DbDataReader reader = DbConnector.Default.ExecuteReader(dbCommand))
				{
					while (reader.Read())
					{
						...
						ObjednavkaSepsani ghost = ghosts[id];
						if (!ghost.IsLoaded)
						{
