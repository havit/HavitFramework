    ...
    public static class ModelClass
    {
        ...
        private static void WriteMembers(CodeWriter writer, GeneratedModelClass modelClass)
        {
            ...
            foreach (EntityCollectionProperty collectionProperty in modelClass.CollectionProperties)
            {
                ...
                if (!string.IsNullOrEmpty(propertyAccessModifierString) && Enum.TryParse(propertyAccessModifierString, true, out AccessModifier accessModifier))
                {
                    attributeBuilder.AddParameter("PropertyAccessModifier", $"AccessModifier.{accessModifier}");
                }
